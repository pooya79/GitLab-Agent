          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-sm font-medium">/api/v1/bot</p>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-sm font-medium">/api/v1/webhooks</p>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <p className="text-sm font-medium">/api/v1/gitlab</p>
                <p className="text-xs text-muted-foreground">
                  GitLab API calls
                </p>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm">GitLab Integration</span>
                <span className="flex items-center gap-2 text-sm">
